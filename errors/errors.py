...
class NoValidRoleError(AException):
    def __init__(self, exception: Exception | None = None, message="The provided role does not exist!", status_code=400):
        super().__init__(exception, message, status_code)


class AlreadyExisting(AException):
    def __init__(self, exception: Exception | None = None, message="The entered values already exist in the database!", status_code=400):
        super().__init__(exception, message, status_code)


class NoValidParameterValueError(AException):
    def __init__(self, exception: Exception | None = None, message="The send parameters have a wrong value!", status_code=400):
        super().__init__(exception, message, status_code)


class NoLearningElementsError(AException):
    def __init__(self, exception: Exception | None = None, message="There are no learning elements for this topic!", status_code=400):
        super().__init__(exception, message, status_code)

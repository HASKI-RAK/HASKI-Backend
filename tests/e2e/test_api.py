...
def test_api_create_user_from_moodle(
    client, input, keys_expected, status_code_expected, save_id
):
    url = path_lms_user
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Teacher not found
        (True, False, ["error"], 404),
        # Course not found
        (False, True, ["error"], 404),
        # Teacher already in Course
        (False, False, ["error"], 400),
    ],
)
def test_add_teacher_to_course(
    client, error_teacher, error_course, keys_expected, status_code_expected
):
...
def test_add_student_to_course(
    client, error_student, error_course, keys_expected, status_code_expected
):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (4, ["error"], 400, False, True, False, False, False),
        # Wrong ID for question
        (4, ["error"], 400, False, False, True, False, False),
        # Wrong answer type for ILS
        (4, ["error"], 400, False, False, False, False, False),
        # Wrong answer type LIST-K
        (4, ["error"], 400, False, False, False, True, False),
        # Wrong question ID for LIST-K
        (4, ["error"], 400, False, False, False, False, True),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Wrong ID for question
        (True, 4, ["error"], 400, False, False, True, False),
        # Wrong answer type for ILS
        (True, 4, ["error"], 400, False, False, False, True),
        # Wrong answer type LIST-K
        (True, 4, ["error"], 400, False, False, False, False),
        # Wrong question ID for LIST-K
        (True, 4, ["error"], 400, False, False, False, False),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Wrong data format
        ({"visit_start": "01.01.2023"}, 4, ["error"], 400),
        # Missing Parameter
        ({"previous_topic_id": 1}, 4, ["error"], 400),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Wrong data format
        ({"visit_start_time": "01.01.2023"}, 4, ["error"], 400),
        # Missing Parameter
        ({"previous_learning_element_id": 1}, 4, ["error"], 400),
    ],
)
...
def test_get_students_learning_characteristics(
    client, lms_user_id, status_code_expected, keys_expected, error
):
    global user_id_student, student_id
    if error:
        student_id_use = 99999
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Student not found
        (1, 404, ["error"], True, False),
        # Course not found
        (1, 404, ["error"], False, True),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Student not found
        (1, 404, ["error"], True, False, False),
        # Course not found
        (1, 404, ["error"], False, True, False),
        # Topic not found
        (1, 404, ["error"], False, False, True),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # User not found
        (1, ["error"], 404, True, False, False),
        # Course not found
        (4, ["error"], 404, False, True, False),
        # Topic not found
        (4, ["error"], 404, False, False, True),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Student not found
        (1, 404, ["error"], True, False, False, False),
        # Course not found
        (1, 404, ["error"], False, True, False, False),
        # Topic not found
        (1, 404, ["error"], False, False, True, False),
        # LE not found
        (1, 404, ["error"], False, False, False, True),
    ],
)
...
def test_get_logs_by_admin_id(
    client, lms_user_id, keys_expected, status_code_expected, error_admin
):
    global user_id_admin, admin_id
    if error_admin:
        user_id_use = 99999
...
def test_update_course_from_moodle(
    client, input, moodle_course_id, keys_expected, status_code_expected
):
    global course_id

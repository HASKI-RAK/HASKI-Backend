...
class OOBN_model:
    ...
    #
    def process_case_1(self,dom, target, names, labels, str_local_target, str_dim_output):
    ...
    def calulated_ILS(self):
        ...
        try:
            ...
            dom = self.load_model(specfile, cls_name)
            ...
            # AR = self.process_case_1(dom, target, AR_names, labels_AR,

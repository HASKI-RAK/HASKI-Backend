class AException(Exception):
    ...
    def __init__(
            self, exception: Exception | None = None, message=None,
            status_code=500):
...
class TypeException(AException):
    ...
    def __init__(
            ...
            message="An unexpected type error occurred.", status_code=500):
        super().__init__(exception, message, status_code)


class MissingParameterError(AException):
    def __init__(self, exception: Exception | None = None,
                 message="Missing parameters in request.", status_code=404):
        super().__init__(exception, message, status_code)
...
class StateNotMatchingError(AException):
    def __init__(self, exception: Exception | None = None,
                 message="The passed state is not matching.", status_code=400):
        super().__init__(exception, message, status_code)


class InvalidJWTError(AException):
    def __init__(self, exception: Exception | None = None,
                 message="The passed JWT is invalid.", status_code=400):
        super().__init__(exception, message, status_code)


class KeyAlreadyExistsError(AException):
    def __init__(self, exception: Exception | None = None,
                 message="The passed key already exists.", status_code=400):
        super().__init__(exception, message, status_code)


class UnauthorizedError(AException):
    def __init__(self, exception: Exception | None = None,
                 message="The request is unauthorized.", status_code=401):
        super().__init__(exception, message, status_code)
...
class NoValidIdError(AException):
    def __init__(self, exception: Exception | None = None,
                 message="This ID does not exist!", status_code=404):
        super().__init__(exception, message, status_code)


class NoContentWarning(AException):
    def __init__(self, exception: Exception | None = None,
                 message="No entries were found!", status_code=204):
        super().__init__(exception, message, status_code)
...
class NoValidRoleError(AException):
    def __init__(self, exception: Exception | None = None,
                 message="The provided role does not exist!", status_code=400):
        super().__init__(exception, message, status_code)

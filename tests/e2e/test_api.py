...
@pytest.mark.parametrize(
    ...
    [
        ...
        (False, 4, ["error"], 400, False, True, False, False, False, False),
        # Wrong ID for question
        (True, 4, ["error"], 400, False, False, True, False, False, False),
        # Wrong answer type for ILS
        (True, 4, ["error"], 400, False, False, False, True, False, False),
        # Wrong answer type LIST-K
        (True, 4, ["error"], 400, False, False, False, False, True, False),
        # Wrong question ID for LIST-K
        (True, 4, ["error"], 400, False, False, False, False, False, True),
    ],
)

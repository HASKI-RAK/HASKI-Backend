...
class SqlAlchemyUnitOfWork(AbstractUnitOfWork):  # pragma: no cover
    ...
    def __enter__(self):
        ...
        self.user =\
            repository.SqlAlchemyRepository(self.session)
        self.ils_input_answers =\
            repository.SqlAlchemyRepository(self.session)
        self.ils_perception_answers =\
            repository.SqlAlchemyRepository(self.session)
        self.ils_processing_answers =\
            repository.SqlAlchemyRepository(self.session)
        self.ils_understanding_answers =\
            repository.SqlAlchemyRepository(self.session)
        self.knowledge =\
            repository.SqlAlchemyRepository(self.session)
        self.learning_analytics =\
            repository.SqlAlchemyRepository(self.session)
        self.learning_characteristics =\
            repository.SqlAlchemyRepository(self.session)
        self.learning_element =\
            repository.SqlAlchemyRepository(self.session)
        self.learning_element_rating =\
            repository.SqlAlchemyRepository(self.session)
        self.learning_path =\
            repository.SqlAlchemyRepository(self.session)
        self.learning_path_learning_element =\
            repository.SqlAlchemyRepository(self.session)
        self.learning_path_topic =\
            repository.SqlAlchemyRepository(self.session)

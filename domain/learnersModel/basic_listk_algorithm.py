...
def calculate_basic_learning_strategy(list_k_answers):
    cogn_str = calculate_cognitive_str(
    ...
    return (cogn_str, metacogn_str, int_res_mng_str, ext_res_mng_str)


def calculate_cognitive_str(
    org1,
    org2,
    org3,
    elab1,
...
def calculate_metacognitive_str(
    goal_plan1, goal_plan2, goal_plan3, con1, con2, con3, reg1, reg2, reg3
):
...
def calculate_internal_resource_management_str(
    att1, att2, att3, eff1, eff2, eff3, time1, time2, time3
):
...
def external_resource_management_str(
    lrn_w_cls1,
    lrn_w_cls2,
    lrn_w_cls3,
    lit_res1,

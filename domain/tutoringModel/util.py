    ...
    for elememnt in learning_elements:
        if elememnt == "KÜ":
            ...
            for key in learning_style.keys():
                if key == "act":
                    coordinate.append(learning_style["act"] * graf[elememnt][0])
                elif key == "ref":
                    coordinate.append(learning_style["ref"] * graf[elememnt][1])
                if key == "sns":
                    coordinate.append(learning_style["sns"] * graf[elememnt][2])
                elif key == "int":
                    coordinate.append(learning_style["int"] * graf[elememnt][3])
                if key == "vis":
                    coordinate.append(learning_style["vis"] * graf[elememnt][4])
                elif key == "vrb":
                    coordinate.append(learning_style["vrb"] * graf[elememnt][5])
                if key == "seq":
                    coordinate.append(learning_style["seq"] * graf[elememnt][6])
                elif key == "glo":
                    coordinate.append(learning_style["glo"] * graf[elememnt][7])
...
def add_Learning_element(learning_elements):
    ...
    elements = ["KÜ", "EK", "ZF", "SE", "FO", "ZL", "AN", "ÜB", "AB", "LZ"]
    id = 0
...
#     else:get_list_learning_element

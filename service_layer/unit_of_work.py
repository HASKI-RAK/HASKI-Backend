...
class SqlAlchemyUnitOfWork(AbstractUnitOfWork):  # pragma: no cover
    ...
    def __enter__(self):
        ...
        self.learning_path_learning_element: repository.SqlAlchemyRepository(self.session)
        ...
        self.student_learning_element_visit: repository.SqlAlchemyRepository(self.session)

...
@pytest.mark.parametrize("error_teacher, error_course, keys_expected,\
                         status_code_expected", [
    # Working Example
    (
        False,
...
@pytest.mark.parametrize("error_student, error_course, keys_expected,\
                         status_code_expected", [
    # Working Example
    (
        False,
        False,
        ['id', 'course_id', 'student_id', 'input_dimension',
         'input_value', 'perception_dimension', 'perception_value',
...
@pytest.mark.parametrize("input, moodle_user_id, keys_expected,\
                         status_code_expected", [
    # Working Example
    (
        {
...
@pytest.mark.parametrize("lms_user_id, status_code_expected, \
                         keys_expected, error", [
    # Working Example
    (
        4,
...
@pytest.mark.parametrize("lms_user_id, status_code_expected,\
    ...
    (
        ...
        200,
        ['topics'],
        ['id', 'lms_id', 'name', 'is_topic', 'contains_le',\
         'university', 'parent_id', 'student_topic'],
        False,
        False
    ),
    # Student not found
...
@pytest.mark.parametrize("lms_user_id, status_code_expected,\
    ...
    (
        ...
        ['learning_elements'],
        ['id', 'lms_id', 'activity_type', 'classification',\
         'name', 'university', 'student_learning_element'],
        False,
        False
    ),
    # Student not found
...
@pytest.mark.parametrize("lms_user_id, keys_expected_1,\
...
@pytest.mark.parametrize("lms_user_id, request_body, \
                         keys_expected, status_code_expected, \
                         error", [
    # Working Example
    (
...
@pytest.mark.parametrize("lms_user_id, request_body, keys_expected,\
                         status_code_expected, error", [
    # Working Example
    (
        4,
...
@pytest.mark.parametrize("input, moodle_course_id, keys_expected,\
                         status_code_expected", [
    # Working Example
    (
        {
...
@pytest.mark.parametrize("input, moodle_course_id, moodle_topic_id,\
